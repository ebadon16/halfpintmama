      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="flex justify-center">
          <iframe
            ...
            className="border-0 rounded-xl overflow-hidden w-full max-w-2xl"
            height="600"
            scrolling="no"
            allowTransparency={true}
            title="Instagram Feed - @halfpint.mama"
          />
        </div>
        ...
        <div className="text-center mt-6">
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-2 px-8 py-3 bg-gradient-to-r from-purple-500 via-pink-500 to-orange-400 text-white font-semibold rounded-full hover:shadow-lg transition-all"
          >
