...
export function RecipeCard({ recipe, title }: RecipeCardProps) {
  ...
  return (
    <div className="recipe-card bg-white rounded-2xl shadow-md p-6 mb-8 print:shadow-none print:border print:border-gray-200">
      <h2 className="font-[family-name:var(--font-crimson)] text-xl font-bold text-deep-sage mb-4 flex items-center gap-2">
