    ...
    <div id="recipe-card" className="recipe-card bg-white rounded-2xl shadow-md p-6 mb-8 print:shadow-none print:border print:border-gray-200">
      <div className="flex items-start justify-between">
        ...
        <Image
          ...
          sizes="112px"
          priority
          className="hidden md:block rounded-full flex-shrink-0 self-center"
        />
      </div>

      {/* Time Info Bar */}
      {hasTimeInfo && (
        <div className="flex flex-wrap gap-4 mb-6 pb-8 border-b border-light-sage md:-mt-16">
          {recipe.prepTime && (
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs text-charcoal/80 uppercase tracking-wide">Prep</p>
          ...
          {recipe.cookTime && (
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs text-charcoal/80 uppercase tracking-wide">Cook</p>
          ...
          {recipe.servings && (
            <div className="flex items-center gap-2">
              ...
              <div>
                <p className="text-xs text-charcoal/80 uppercase tracking-wide">Servings</p>
