    ...
    <div className="bg-cream">
      ...
      <article className="max-w-2xl mx-auto px-4 py-8">
        ...
        <header className="mb-6">
          ...
          {/* Share, Save, Quick Links & Print Buttons */}
          <div className="mt-4 flex flex-wrap items-center gap-3">
            ...
            {post.category === "cooking" && post.recipe && (
              <>
                <a
                  href="#recipe-card"
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-terracotta/10 text-terracotta text-sm font-medium rounded-full hover:bg-terracotta hover:text-white transition-all"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <a
                  href="#comments"
                  className="inline-flex items-center gap-1.5 px-3 py-1.5 bg-sage/10 text-sage text-sm font-medium rounded-full hover:bg-sage hover:text-white transition-all"
                >
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
