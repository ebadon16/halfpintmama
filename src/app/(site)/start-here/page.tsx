        ...
        <div className="bg-gradient-to-br from-light-sage/30 to-warm-beige/30 rounded-2xl p-8 md:flex items-center gap-8">
          ...
          <div>
            ...
            <p className="text-charcoal/80 mb-4">
              I&apos;m a Pediatric ER RN, mama of three, and author of <em>Rest &amp; Rise</em>, sharing life&apos;s beautiful chaos with my kids and our chocolate lab Stout. I started this blog to get back to the basics: real food, simple recipes, and intentional living. Sourdough, family adventures, or honest motherhood, you&apos;ll find it all here.
            </p>
            <Link
              href="/about"
