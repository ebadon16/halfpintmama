        ...
        <div className="flex flex-col lg:flex-row gap-8">
                          ...
                          {latestPost.ratingCount != null && latestPost.ratingCount > 0 && (
                            <>
                              ...
                              <div className="flex items-center gap-1 text-sm text-charcoal/80">
                                ...
                                <span className="text-charcoal/80">({latestPost.ratingCount})</span>
                              </div>
                            </>
                          )}
                        </div>
          ...
          <aside className="lg:w-80 flex-shrink-0">
            ...
            <div className="bg-white p-6 rounded-2xl shadow-md mb-6 border-2 border-terracotta/20 text-center">
              ...
              <p className="text-charcoal/80 text-sm mb-4">
                My postpartum cookbook: 35 make-ahead, freezer-friendly recipes for the fourth trimester. Every copy from my shop is signed.
              </p>
              <Link
                href="/shop"
                  ...
                  {popularPosts.filter(p => p.ratingCount && p.ratingCount > 0).slice(0, 3).map((post) => (
                    <Link key={post.slug} href={`/posts/${post.slug}`} className="block group">
                      ...
                      <div className="flex items-center gap-1 mt-1">
                        ...
                        <span className="text-charcoal/80 text-xs ml-1">({post.ratingCount})</span>
                      </div>
                    </Link>
                  ))}
                </div>
